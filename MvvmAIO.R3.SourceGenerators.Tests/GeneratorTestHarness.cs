...
internal static class GeneratorTestHarness
{
        ...
        IIncrementalGenerator[]? generators = null)
    {
        ...
        IIncrementalGenerator[] useGenerators = generators ?? new IIncrementalGenerator[]
        {
            new ObservableEventsGenerator(),
            new R3CommandGenerator(),
        };
    ...
    public static string ToSnapshot(GeneratorRunOutput output)
    {
        ...
        ImmutableArray<Diagnostic> diagnostics = output.Diagnostics
            .Where(static d => d.Id.StartsWith("R3SG", StringComparison.Ordinal))
