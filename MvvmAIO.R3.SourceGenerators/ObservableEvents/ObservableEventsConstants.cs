...
{
    internal const string BootstrapExtensionsMetadataName = "R3.SourceGenerators.ObservableEventsBootstrapExtensions";
    internal const string GeneratedNamespace = "R3.SourceGenerators";
